...
class Project(QWidget):
    def __init__(self, fhndl: ProjectFileHandler, lfhndl: ReferencedProjectHandler, parent=None):
        ...
        self.wx_training_page = TrainingPage(self.fhndl, self.models, self.io_configs_train, parent=self)
        self.wx_deployment_page = DeploymentPage(self.fhndl, self.models, self.io_configs_train, self.io_configs_pred, parent=self)
