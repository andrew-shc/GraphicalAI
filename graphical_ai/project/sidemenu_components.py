...
class FileConfigDialog(QDialog):
    ...
    def get_input(self) -> (str, bool):
        self.exec_()
        return self.input_filename, self.input_ok
...
class IOField(QWidget):
    ...
    def __init__(self, attr_name: str, state: NodeState, parent=None):
        super().__init__(parent=parent)
    ...
    def sl_open_config(self):
        ...
        dprint("OPEN CONFIG RETURNS:", ret)
...
class ModelIOConfigurator(QListWidget):
    ...
    @Slot(str, NodeState)
    def create_new_attr(self, attr_name: str, node_state: NodeState):
        qlwi_attr = QListWidgetItem()
        attribute = IOField(attr_name, node_state)
